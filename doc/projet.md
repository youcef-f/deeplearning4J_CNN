# prediction des chiffres de 0 à 9

# deziper le fichier mnist_png.tar.gz
![](images/projets1.jpg)
le nom dossier défini le nom de la classe.  exemple dossier "0" pour définir la classe "0"

Pour utiliser CUDA il faut avoir des cartes Graphique de NVIDEA
...
##fully coonnected layer ( Dense layer)
![](images/cnn4.jpg)
